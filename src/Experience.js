  ...
  return (
    ...
    <div className='flex flex-col h-[120vh]'>
      <div className='flex justify-between items-center h-[60px] mt-[1vh]'>
        <Link to="/"><Fab variant='extended' aria-label='back' sx={{marginLeft: "10px", bgcolor: "#072b57", ":hover": {bgcolor: "#0a52a8"},}}><ArrowBackIcon sx={{color: "#fff"}}/></Fab></Link>
      ...
      <div className='flex mt-[5vh] h-[40vh] justify-center gap-[6vw]'>
        ...
        <div   className='h-[45vh] w-[40vw] flex flex-col items-center shadow-lg rounded-lg mt-[6vh]'>
          <div className='mt-[2vh] flex gap-[2vw]'>
          <img alt='img' className='h-[9vh] rounded-xl' src="https://media.licdn.com/dms/image/C560BAQEpT9vFvX2mIQ/company-logo_100_100/0/1563042618577?e=1693440000&v=beta&t=h7K7ukAc_1AE-JCOtyN4u_NianOoo_dxMszdgX9eh-0"/>
          <div>
        ...
        <div   className='h-[45vh] w-[40vw] flex flex-col items-center shadow-lg rounded-lg'>
          <div className='mt-[2vh] flex gap-[2vw]'>
          <img alt='img' className='h-[8vh] rounded-xl' src="https://media.licdn.com/dms/image/C4E0BAQG0b6sYi7Q4TA/company-logo_100_100/0/1668088153612?e=1693440000&v=beta&t=OOInzqagI6fb29z5jQ1fEKxYn3o6WUQz0UIK9JeqW1U"/>
          <div>
